...
\newcommand{\cp}{C-process} 
\newcommand{\cps}{C-processes} 
...
% ============================================================================ %
	\section{\acf{OurTheory}}\label{sec:OurTheory}
       ...
       \end{definition}
        ...
        \begin{description}
            ...
            % There are no coarse-grainings that contain information about the future of the conscious process that is not already contained in the conscious process itself. 
            ...
            % \item[Implication 4.] Conscious processes can be ignorant to part of the information of more microscopic processes and must be ignorant to part of the information about the universe process. This is due to $Y$ being a coarse-graining of the universe process $X$ and NTIC to the environment $E$. The environment must contain information (have multiple possible states) for NTIC to be positive. At a given time $t$ this information in $E_t$ must then be missing from $Y_t$  
            % and possible intermediate coarse-grainings between $X$ and $Y$. 
            
            
            % \item[Implication 5.] Even though conscious processes are ignorant of are informationally closed with respect to all other coarse-grainings of the universe. This is a direct consequence of $Y$ being informationally closed with respect to $X$. 
            % Informational closure can occur between levels in a system. The macroscopic level $Y$ can be informationally closed with respect to its microscopic level $S$ within a system \citep{PFANTE.2014}.
            
            
            % This implication is in line with our conscious experience that information provided by every conscious percept is limited.
            % This means that the physical representations of the contents of any consciousness must be a coarse-graining of the universe states and also informationally closed to the universe. \\
    ...
    %         Together with the first three implications, this means that the physical representations of the contents of any consciousness must be a coarse-graining of the universe states and also informationally closed to the universe.
...
% ============================================================================ %
	...
	A.C., Y.Y, and R.K. are funded by Japan Science and Technology Agency (JST) CREST project. R.K. and M.B. are supported by Templeton World Charity Foundation.
	   % Thank David Schwartzman for letting me concertrate several months for this work. 
