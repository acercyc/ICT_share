...
\begin{document}
    ...
    \section{Reply to Reviewer 1}
        ...
        \begin{ans}
        	The reviewer is right. Feed-forward networks can be conscious under ICT. We thank the reviewer to correct this point. Similarly, a video camera can achieve positive levels of NTIC and, therefore, be conscious. We have worked extensively on Section 5 to make this clear (see from Line:~\lineref{line:notIC}).
