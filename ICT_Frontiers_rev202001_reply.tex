...
%			A partition of $Y$ is a set $P_y$ which divides $Y$ into two subsets $P_y=\{Y_1, Y_2\}$. }    		    		    		
        ...
        \begin{ans}
            \toWrite{Thinking to combine the answer to this question with other answers. But not sure yet. Need to think about it. We can skip this one for now.}
...
%    		\end{enumerate}
    	...
    	\begin{ans}
    		We have invited a native English speaker for proofreading. Please inform us if it is still not clear and readable. 
    	\end{ans}
...
%			In our hypothesis, Y is IC with respect to the microstate of the universe, X. This is critical in the hypothesis because Y is IC with respect to X, implying that Y is also IC with respect to its intermediate level S and its environment E in Fig. \ref{fig:fullgraph}.\todo{need any change in the main text?}
    	...
    	\begin{ans}
    		\todo{I think I made a big mistake in the manuscript. When I wrote this part I only considered IC as a function of scales of coarse-graining. But I just realised NTIC is totally a different story that I didn't think about thoroughly. I may need to re-write this paragraph}
