...
\begin{document}
    ...
    \section{Reply to Reviewer 1}
        ...
        \begin{ans}
        	The reviewer is right. We have reconsidered case of the feed-forward networks and the video camera example (which can be considered as a single layer feed-forward networks). According to ICT, feed-forward networks can be conscious under under some specific constrains. We thank the reviewer to correct this point. Similarly, a video camera can achieve positive levels of NTIC and, therefore, be conscious. We have worked extensively on Section \ref{sec:causality} and Section 5 to make this clear (for Section 5, please see from Line:~\lineref{line:notIC}).
        	...
        	\begin{itemize}
        	    ...
        	    \item Extensively modify the paragraph about feed-forward networks and memory in Section 5
...
%    		\end{enumerate}
    ...
    % 		We agree that we did not indicate this assumption explicitly and may lead to some confusion for our readers. 
    	...
    	\begin{ans}
    	We have added a whole new paragraph to explain this session. We also agree that our claim about existing a intermediate maxima in NTIC was too strong and have revised the paragraph as follows: 
    	...
    	\end{ans}
    	We also added a new section (Section \ref{sec:causality}) to describe the scenario of modelling. 
   	...
   	\begin{question}
    	...
    	\end{question}
 		...
 		\begin{ans}
 		    The reviewer is correct. Based on the 
            Because another reviewer also proposed relevent questions and based on some reconsideration, 
