...
\begin{document}
    ...
    \section{Reply to Reviewer 1}
    	...
    	\begin{ans}
    		...
    		It is true that having high NTIC $I(Y_{t+1}; E_t)$ needs to be high. However, based on the setting in both Bertschinger et al. 2006 and our Section 2 (from Line \lineref{line:r1q1a}),  if $Y_t$ does not have information $J_t(E -> Y)$
    		...
    		We have added a short paragraph about this issue at Line \lineref{line:r1-state-dep}.
